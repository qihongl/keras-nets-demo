...
def load_cifar(data_name):
    """
    useage:
    X_train, X_test, Y_train, Y_test, y_train, y_test, data_info = \
        load_cifar(data_name)
...
def load_mnist(shape='std'):
    ...
    if shape == 'std':
        ...
        x_train = x_train.reshape(
            x_train.shape[0], img_rows, img_cols, img_channels)
        x_test = x_test.reshape(
            x_test.shape[0], img_rows, img_cols, img_channels)
